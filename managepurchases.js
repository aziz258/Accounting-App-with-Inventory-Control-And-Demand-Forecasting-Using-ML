...
const Managepurchases = ({ navigation }) => {
  return (
     <View style={styles.container}>
       <View style={styles.header}>
         <Text style={styles.heading}>Manage Purchases</Text>
       </View>
       ...
       <View style={styles.buttonContainer}>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('pinvc')}
           activeOpacity={0.7}>
         ...
         <TouchableOpacity
           ...
           <Text style={styles.buttonText}>Purchase Return Invoice</Text>
         </TouchableOpacity>
