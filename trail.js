...
const TrialBalance = () => {
    ...
    const openReport = () => {
        ...
        const pdfUrl = `https://5461283ce09c.ngrok-free.app/myapp/rpttrialbalance.php?com_code=${companyCode}&date=${formatDate(selectedDate)}`;
    ...
    return (
        <View style={styles.container}>
            ...
            <LinearGradient colors={['#6200ee', '#3700b3']} style={styles.gradient}>
                <Text style={styles.heading}>Trial Balance Report</Text>
            </LinearGradient>
