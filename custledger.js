...
const CustLedger = () => {
    ...
    const openReport = () => {
        ...
        const pdfUrl = `https://5461283ce09c.ngrok-free.app/myapp/rptcustledger.php?com_code=${companyCode}&account_no=${encodeURIComponent(accountNo)}&account_name=${encodeURIComponent(accountName)}&from_date=${formatDate(fromDate)}&to_date=${formatDate(toDate)}`;
    ...
    useEffect(() => {
        ...
        axios
          .get("https://5461283ce09c.ngrok-free.app/myapp/fetchcustledgeraccounts.php")
          .then((response) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <LinearGradient colors={['#6200ee', '#3700b3']} style={styles.gradient}>
                <Text style={styles.heading}>Customer Ledger</Text>
            </LinearGradient>
