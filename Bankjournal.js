...
const [showModifyDeleteModal, setShowModifyDeleteModal] = useState(false); // Modal for modify/delete option
  ...
  useEffect(() => {
    axios
      .get("https://5461283ce09c.ngrok-free.app/myapp/fetchbjvno.php")
      .then((response) => {
  ...
  const insertData = async () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertbjvno.php", {
      method: "POST",
      headers: {
...
>
  ...
  <Text style={styles.heading}>Bank Deposit/Draw</Text>
</View>
    ...
    <View style={styles.row}>
      <View style={styles.inputContainer}>
        <Text style={styles.label}>B-JV No:</Text>
        <TextInput
          style={styles.input}
