...
const SaleJournal = () => {
    ...
    const openReport = () => {
        ...
        const pdfUrl = `https://5461283ce09c.ngrok-free.app/myapp/rptsaleju.php?com_code=${companyCode}&from_date=${formatDate(fromDate)}&to_date=${formatDate(toDate)}`;
    ...
    return (
        <View style={styles.container}>
            ...
            <LinearGradient colors={['#6200ee', '#3700b3']} style={styles.gradient}>
                <Text style={styles.heading}>Sale Journal Report</Text>
            </LinearGradient>
