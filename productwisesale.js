...
const productsale = () => {
  ...
  const openReport = () => {
    ...
    const pdfUrl = `https://5461283ce09c.ngrok-free.app/myapp/rptproductsale.php?com_code=${companyCode}&from_date=${formatDate(selectedDate)}&to_date=${formatDate(toDate)}&deptno=${selectedDeptNo}`;
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#6200ee', '#3700b3']} style={styles.gradient}>
        <Text style={styles.heading}>Product Wise Sale</Text>
      </LinearGradient>
