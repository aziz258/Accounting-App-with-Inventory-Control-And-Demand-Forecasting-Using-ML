  ...
  return (
     <View style={styles.container}>
       <View style={styles.header}>
         <Text style={styles.heading}>Manage Sales</Text>
       </View>
       ...
       <View style={styles.buttonContainer}>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('saleinvc')}
           activeOpacity={0.7}>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('salereturninvc')}
           activeOpacity={0.7}>
           <Icon name="cash-edit" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Sale Return Invoice</Text>
         </TouchableOpacity>
