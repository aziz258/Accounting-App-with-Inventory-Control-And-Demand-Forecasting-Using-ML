...
const Managebankjournal = ({ navigation }) => {
  return (
     <View style={styles.container}>
       <View style={styles.header}>
         <Text style={styles.heading}>Manage Bank Journal's</Text>
       </View>
       ...
       <View style={styles.buttonContainer}>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('Bank journal')}
           activeOpacity={0.7}>
           <Icon name="cash-plus" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Bank Deposit/Draw</Text>
         </TouchableOpacity>
 
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('ModifyBankJournal')}
           activeOpacity={0.7}>
           <Icon name="cash-edit" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Modify Bank Deposit/Draw</Text>
         </TouchableOpacity>
...
export default Managebankjournal;
