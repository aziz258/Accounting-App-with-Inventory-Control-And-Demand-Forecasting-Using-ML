  ...
  return (
     <View style={styles.container}>
       <View style={styles.header}>
         <Text style={styles.heading}>Manage Customer's/Suppliers's</Text>
       </View>
       ...
       <View style={styles.buttonContainer}>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('modifysupplier')}
           activeOpacity={0.7}>
           <Icon name="cash-edit" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Modify Supplier</Text>
         </TouchableOpacity>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('modifycustomer')}
           activeOpacity={0.7}>
           <Icon name="cash-edit" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Modify Customer</Text>
         </TouchableOpacity>
