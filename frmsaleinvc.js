...
const handleSubmit = async () => {
  ...
  try {
    const response = await fetch("https://5461283ce09c.ngrok-free.app/myapp/insertinvc.php", {
      method: "POST",
      headers: {
...
const handleDiscountChange = (value) => {
 ...
 const fetchGrno = () => {
    axios.get("https://5461283ce09c.ngrok-free.app/myapp/fetchinvc.php")
      .then((res) => {
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.headingContainer}>
          <Text style={styles.heading}>Sale Invoice</Text>
        </View>
