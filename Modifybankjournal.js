...
const [showModifyDeleteModal, setShowModifyDeleteModal] = useState(false); // Modal for modify/delete option
  ...
  const insertData = async () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertmodifybjv.php", {
      method: "POST",
      headers: {
  ...
  const fetchData = () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/fetchnbjvdata.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
>
  ...
  <Text style={styles.heading}>Modify Bank Draw/Deposit</Text>
</View>
...
export default Modifybankjournal;
