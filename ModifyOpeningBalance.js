...
const [showModifyDeleteModal, setShowModifyDeleteModal] = useState(false); // Modal for modify/delete option
  ...
  const insertData = async () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertmodifyobal.php", {
      method: "POST",
      headers: {
  ...
  const fetchData = () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/fetchobaldata.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
>
  ...
  <Text style={styles.heading}>Modify Opening Balances</Text>
</View>
  ...
  <View style={styles.inputContainer}>
    <Text style={styles.label}>OJV No:</Text>
    <TextInput 
      style={styles.input} 
      value={ojvno} 
