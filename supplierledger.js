...
const SupplierLedger = () => {
    ...
    const openReport = () => {
        ...
        const pdfUrl = `https://5461283ce09c.ngrok-free.app/myapp/rptsupplierledger.php?com_code=${companyCode}&account_no=${encodeURIComponent(accountNo)}&account_name=${encodeURIComponent(accountName)}&from_date=${formatDate(fromDate)}&to_date=${formatDate(toDate)}`;
    ...
    useEffect(() => {
        ...
        axios
          .get("https://5461283ce09c.ngrok-free.app/myapp/fetchsupplieraccounts.php")
          .then((response) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <LinearGradient colors={['#6200ee', '#3700b3']} style={styles.gradient}>
                <Text style={styles.heading}>Supplier Ledger</Text>
            </LinearGradient>
