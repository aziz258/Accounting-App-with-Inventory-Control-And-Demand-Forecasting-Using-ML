...
const [showModifyDeleteModal, setShowModifyDeleteModal] = useState(false); // Modal for modify/delete option
  ...
  useEffect(() => {
    axios
      .get("https://5461283ce09c.ngrok-free.app/myapp/fetchojvno.php")
      .then((response) => {
  ...
  const insertData = async () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertobalance.php", {
      method: "POST",
      headers: {
...
>
  ...
  <Text style={styles.heading}>Add Opening Balances</Text>
</View>
