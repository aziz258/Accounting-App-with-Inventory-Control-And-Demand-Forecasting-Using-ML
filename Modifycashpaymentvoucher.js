...
const Modifycashpaymentvoucher = () => {
...
const [showModifyDeleteModal, setShowModifyDeleteModal] = useState(false); // Modal for modify/delete option
  ...
  const insertData = async () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertmodifypvno.php", {
      method: "POST",
      headers: {
  ...
  const fetchData = () => {
      ...
      fetch("https://5461283ce09c.ngrok-free.app/myapp/fetchpvnodata.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    const addFetchedRows = (fetchedData) => {
        const updatedRows = fetchedData.map((rowData, index) => ({
          ...
          receipts: parseFloat(rowData.debit) || 0,
...
>
  ...
  <Text style={styles.heading}>Modify Cash Payment Voucher</Text>
</View>
...
export default Modifycashpaymentvoucher;
