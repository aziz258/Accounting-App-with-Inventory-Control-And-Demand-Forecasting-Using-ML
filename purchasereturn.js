...
const handleSubmit = async () => {
  ...
  try {
    const response = await fetch("https://5461283ce09c.ngrok-free.app/myapp/insertprinvc.php", {
      method: "POST",
      headers: {
...
const handleDiscountChange = (value) => {
 ...
 const fetchGrno = () => {
    axios.get("https://5461283ce09c.ngrok-free.app/myapp/fetchrgrno.php")
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios.get("https://5461283ce09c.ngrok-free.app/myapp/fetchpurchaseacct.php")
      .then((res) => {
        if (res.data.success) {
    ...
    axios.get("https://5461283ce09c.ngrok-free.app/myapp/fetchsuppliers.php")
      .then((res) => {
        if (res.data.success) {
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.headingContainer}>
          <Text style={styles.heading}>Purchase Return Invoice</Text>
        </View>

        {/* Gr No and Date */}
        <View style={styles.row}>
          <View style={styles.inputContainer}>
            <Text style={styles.label}>R-Gr No:</Text>
        ...
        <View style={styles.row}>
          <View style={styles.inputContainer}>
            <Text style={styles.label}>Debit Account No:</Text>
          ...
          <View style={styles.inputContainer}>
            <Text style={styles.label}>Debit Account Name:</Text>
...
export default Purchasereturninvc;
