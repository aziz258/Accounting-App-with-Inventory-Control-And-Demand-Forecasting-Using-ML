...
const ManageJournals = ({ navigation }) => {
  return (
     <View style={styles.container}>
       <View style={styles.header}>
         <Text style={styles.heading}>Manage Journal's</Text>
       </View>
       ...
       <View style={styles.buttonContainer}>
         ...
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('journalvoucher')}
           activeOpacity={0.7}>
           <Icon name="cash-plus" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Add Journal Voucher</Text>
         </TouchableOpacity>
 
         <TouchableOpacity
           style={styles.button}
           onPress={() => navigation.navigate('Modifyjournalvoucher')}
           activeOpacity={0.7}>
           <Icon name="cash-edit" size={28} color="white" />  {/* Updated to cash-plus */}
           <Text style={styles.buttonText}>Modify Journal Voucher</Text>
         </TouchableOpacity>
