...
const [showModifyDeleteModal, setShowModifyDeleteModal] = useState(false); // Modal for modify/delete option
  ...
  useEffect(() => {
    axios
      .get("https://5461283ce09c.ngrok-free.app/myapp/fetchpvno.php")
      .then((response) => {
  ...
  const insertData = async () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertpvno.php", {
      method: "POST",
      headers: {
...
>
  ...
  <Text style={styles.heading}>Cash Payment Voucher</Text>
</View>
  ...
  <TouchableOpacity onPress={addRow} style={styles.addRowButton}>
    ...
    <View style={styles.tableHeader}>
      ...
      <Text style={styles.tableHeaderText}>Payments</Text>
    </View>
    <FlatList
      data={rows}
      keyExtractor={(item, index) => index.toString()}
