...
const AddNewcustomer = () => {
  ...
  useEffect(() => {
    fetch("https://5461283ce09c.ngrok-free.app/myapp/latestcustomer.php")
      .then((res) => res.json())
      .then((data) => {
        if (data.success) {
  ...
  const handleSubmit = () => {
    ...
    fetch("https://5461283ce09c.ngrok-free.app/myapp/insertcustomer.php", {
      method: "POST",
      headers: {
      ...
      .catch((error) => {
        ...
        Alert.alert("Error", "Unable to add the customer.");
      });
  };
